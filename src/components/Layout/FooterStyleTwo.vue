    ...
    <div class="footer-area footer-style-two">
        <div class="container">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-footer-widget">
                        ...
                        <ul class="social-links">
                            ...
                            <li>
                                <a href="https://messenger.com/" target="_blank"><i class="ri-messenger-fill"></i></a>
                            </li>
                            <li>
            ...
            <div class="copyright-area">
                <p>Copyright {{currentYear}} <strong>Deal Dox</strong>. All Rights Reserved by <a href="https://www.dealdox.io/" target="_blank">EnvyTheme</a></p>
            </div>
        </div>
    </div>
</template>
